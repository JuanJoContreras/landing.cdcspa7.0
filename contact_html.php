...
$asunto        = '=?UTF-8?B?' . base64_encode("Nueva cotización CDC SPA — $nombre") . '?=';
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(26,60,94,0.10);">
        ...
        <tr>
          <td style="background:#1A3C5E;padding:32px 40px;text-align:center;">
            <div style="display:inline-block;border:2px solid #EA580C;border-radius:8px;padding:6px 18px;margin-bottom:10px;">
        ...
        <tr>
          <td style="padding:32px 40px 8px;text-align:center;">
            <h1 style="margin:0;font-size:22px;color:#1A3C5E;font-weight:800;">Formulario de Cotización</h1>
        ...
        <tr><td style="padding:16px 40px 0;">
          <div style="height:2px;background:linear-gradient(90deg,#1A3C5E,#EA580C);border-radius:2px;"></div>
        </td></tr>
          ...
          <td style="padding:24px 40px;">
            <table width="100%" cellpadding="0" cellspacing="0"
              ...
              <tr style="background:#F5F5F7;">
                <td colspan="2" style="padding:12px 20px;font-size:12px;font-weight:700;color:#1A3C5E;
                  letter-spacing:1px;text-transform:uppercase;">Datos del cliente</td>
              </tr>
              ...
              <tr style="border-top:1px solid #e5e7eb;background:#fafafa;">
                <td style="padding:12px 20px;font-size:13px;color:#8A8A8E;font-weight:600;">Teléfono / WhatsApp</td>
              ...
              <tr style="border-top:1px solid #e5e7eb;background:#fafafa;">
                <td style="padding:12px 20px;font-size:13px;color:#8A8A8E;font-weight:600;">Comuna / Región</td>
        ...
        <tr>
          <td style="padding:0 40px 24px;">
            <table width="100%" cellpadding="0" cellspacing="0"
              style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
              <tr style="background:#F5F5F7;">
                <td style="padding:12px 20px;font-size:12px;font-weight:700;color:#1A3C5E;
                  letter-spacing:1px;text-transform:uppercase;">Mensaje</td>
              </tr>
              <tr style="border-top:1px solid #e5e7eb;">
                <td style="padding:16px 20px;font-size:13px;color:#4A4A4A;line-height:1.6;">
                  ' . ($mensaje ?: '<span style="color:#8A8A8E;">Sin mensaje adicional</span>') . '
                </td>
              </tr>
            </table>
          </td>
        ...
        <!-- Footer -->
        <tr>
          <td style="background:#1A3C5E;padding:20px 40px;text-align:center;">
            <a href="https://cdcspa.cl" style="color:#EA580C;font-size:12px;text-decoration:none;font-weight:700;">
              www.cdcspa.cl
            </a>
            <p style="margin:6px 0 0;color:#8A8A8E;font-size:11px;">
...
$headers  = "From: =?UTF-8?B?" . base64_encode("CDC SPA <no-reply@cdcspa.cl>") . "?=\r\n";
...
$enviado = mail($destinatarios, $asunto, base64_encode($html), $headers);

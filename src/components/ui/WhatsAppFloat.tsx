      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {showLabel && (
              <motion.div
                ...
                className="bg-white text-brand-gray text-xs font-semibold px-4 py-2.5 rounded-full shadow-lg whitespace-nowrap border border-gray-100"
              >
                💬 ¡Chatea con nosotros!
              </motion.div>
            )}
          ...
          <a
            ...
            aria-label="Contactar CDC SPA por WhatsApp"
          >
